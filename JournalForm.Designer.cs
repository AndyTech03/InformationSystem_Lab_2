namespace InformationSystem_Lab_2
{
	partial class JournalForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.Events = new System.Data.DataTable();
			...
			this.GlobalSearchTSM = new System.Windows.Forms.ToolStripMenuItem();
			...
			// Events
			// 
			this.Events.Columns.AddRange(new System.Data.DataColumn[] {
            this.dataColumn1,
            this.dataColumn2,
            this.dataColumn3,
            this.dataColumn4,
            this.dataColumn5});
			this.Events.TableName = "Events";
			// 
			// dataColumn1
			// 
			...
			this.userIpDataGridViewTextBoxColumn.Width = 200;
			// 
			...
			this.eventDetailDataGridViewTextBoxColumn.Width = 400;
			// 
			// menuStrip1
			// 
			...
			// GlobalSearchTSM
			// 
			this.GlobalSearchTSM.Name = "GlobalSearchTSM";
			this.GlobalSearchTSM.Size = new System.Drawing.Size(154, 28);
			this.GlobalSearchTSM.Text = "Глобальный поиск";
			// 
			// RefreshTSM
			// 
		...
		private System.Data.DataTable Events;
		...
		private System.Windows.Forms.ToolStripMenuItem GlobalSearchTSM;
